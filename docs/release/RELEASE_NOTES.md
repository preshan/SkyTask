...
### Changes
- Updated Privacy Policy across the app and https://preshan.github.io/SkyTask/privacy.html

---

## 1.12.3 — 2026-09-14 · `1.12.3+26`

[Download SkyTask-1.12.3.apk](https://github.com/preshan/SkyTask/releases/download/v1.12.3/SkyTask-1.12.3.apk)

### Changes
- Flat primary-blue app icon across launcher, splash, and in-app

---

## 1.12.2 — 2026-09-14 · `1.12.2+25`

[Download SkyTask-1.12.2.apk](https://github.com/preshan/SkyTask/releases/download/v1.12.2/SkyTask-1.12.2.apk)

### Changes
- Privacy policy page and help copy ready for public hosting
- About & help matches Settings navigation (no text overlap)
- Day Plan opens items directly; clearer opaque blocks and blue timeline
- New app icon PNG

---

## 1.12.1 — 2026-09-14 · `1.12.1+24`

[Download SkyTask-1.12.1.apk](https://github.com/preshan/SkyTask/releases/download/v1.12.1/SkyTask-1.12.1.apk)

### Changes
- App icon PNG with transparent corners (no black fill outside the squircle)

---

## 1.12.0 — 2026-09-14 · `1.12.0+23`

[Download SkyTask-1.12.0.apk](https://github.com/preshan/SkyTask/releases/download/v1.12.0/SkyTask-1.12.0.apk)

### Changes
- New app icon; About & help between notifications and Settings
- Privacy Policy, FAQ, and Data safety & permissions (in-app + Play docs)
- Async lists show Retry on error; dropdown deprecation cleanup
